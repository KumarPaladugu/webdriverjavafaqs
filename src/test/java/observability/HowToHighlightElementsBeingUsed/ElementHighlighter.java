...
public class ElementHighlighter implements WrapsDriver {
    ...
    public ElementHighlighter(final WebDriver aDriver, final String desiredBackgroundColour) {
        driver = new EventFiringWebDriver(aDriver);
        driver.register(new ElementHighlighterListener(driver, desiredBackgroundColour));
    }
    ...
    private class ElementHighlighterListener extends AbstractWebDriverEventListener {
        ...
        public ElementHighlighterListener(WebDriver driver, final String highlightColour) {
